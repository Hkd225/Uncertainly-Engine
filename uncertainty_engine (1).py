...
class UncertaintyEngine(_BaseUncertaintyEngineV4_2):
    ...
    def update_calibration(self, actual_success: float, predicted_confidence: float, context: Dict = None):
        context = context or {}
        ...
        try:
            return super().update_calibration(actual_success, predicted_confidence, context)
        except Exception:
